...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Gauge_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 20, 11), // "updateValue"
QT_MOC_LITERAL(4, 32, 1), // "v"
QT_MOC_LITERAL(5, 34, 5) // "value"

    },
    "Gauge\0valueChanged\0\0updateValue\0v\0"
    "value"
};
...
void Gauge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Gauge *_t = static_cast<Gauge *>(_o);
        switch (_id) {
        case 0: _t->valueChanged(); break;
        case 1: _t->updateValue((*reinterpret_cast< const double(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Gauge::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Gauge::valueChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Gauge::staticMetaObject = {
    { &QDeclarativeItem::staticMetaObject, qt_meta_stringdata_Gauge.data,
      qt_meta_data_Gauge,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Gauge::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Gauge.stringdata))
